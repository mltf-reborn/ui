  ...
  private initForm() {
    this.loanForm = this.fb.group({
      applicationDetails: this.fb.group({
        ...
        purposeOfFacility: ['', Validators.required],
        refinancingBank: [''],
        termLoan: [false],
        housingLoan: [true],
      ...
      primaryPersonal: this.fb.group({
        ...
        bumiputeraStatus: ['no', Validators.required],
        gender: ['', Validators.required],
        maritalStatus: ['', Validators.required],
        dob: ['', Validators.required],
        age: [{ value: 0, disabled: true }],
        dependentsCount: [0, [Validators.required, Validators.min(0)]],
        schoolingChildrenCount: [0, [Validators.required, Validators.min(0)]],
      ...
      primaryContact: this.fb.group({
        ...
        lengthOfStayYears: [0, [Validators.required, Validators.min(0)]],
        lengthOfStayMonths: [0, [Validators.required, Validators.min(0), Validators.max(11)]],
        mailingAddressSame: [true],
        mailingAddressLine1: [''],
        mailingAddressLine2: [''],
        mailingPostcode: [''],
      ...
      primaryEmployment: this.fb.group({
        ...
        employerAddressLine1: ['', Validators.required],
      ...
      primaryIncome: this.fb.group({
        monthlyGrossIncome: [0, [Validators.required, Validators.min(0)]],
      ...
      propertyDetails: this.fb.group({
        ...
        phaseCode: [''],
        contractorName: [''],
        spaPrice: [0, [Validators.required, Validators.min(0)]],
        ...
        mukim: ['', Validators.required],
        district: ['', Validators.required],
        stateGeran: ['', Validators.required],
        titleType: ['freehold', Validators.required],
        isOwnerOccupied: ['no', Validators.required],
        isFirstTimePurchaser: ['no', Validators.required],
        grossPurchasePrice: [0, [Validators.required, Validators.min(0)]],
        discount: [0],
        rebate: [0],
        adjustment: [0],
        developerBenefits: [0],
        netPurchasePrice: [{ value: 0, disabled: true }]
      }),
      ...
      signatures: this.fb.group({
        primarySignatureName: ['', Validators.required],
