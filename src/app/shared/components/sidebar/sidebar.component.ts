...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  // Default menu groups for Mortgage Portal
  readonly navItems = input<NavItem[]>([
    {
      name: 'Papan Pemuka (Dashboard)',
  ...
  readonly othersItems = input<NavItem[]>([
    {
      name: 'Portal Pembiayaan',
      ...
      subItems: [
        { name: 'Semakan SJKP (Gig)', path: '/dashboard' },
        { name: 'Skim Rumah Pertama B40', path: '/dashboard' },
        { name: 'Pakej M50 Flexi', path: '/dashboard' },
      ],
    },
  ]);
